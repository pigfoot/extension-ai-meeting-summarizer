# content-scripts - Task 18

Execute task 18 for the content-scripts specification.

## Task Description
Create event subscriber in pages/content/src/communication/event-subscriber.ts

## Code Reuse
**Leverage existing code**: pages/content/src/communication/message-dispatcher.ts
...
## Usage
```
/Task:18-content-scripts
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create event subscriber in pages/content/src/communication/event-subscriber.ts"

```
Use the @spec-task-executor agent to implement task 18: "Create event subscriber in pages/content/src/communication/event-subscriber.ts" for the content-scripts specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create event subscriber in pages/content/src/communication/event-subscriber.ts
- Leverage: pages/content/src/communication/message-dispatcher.ts
- Requirements: 3.2

## Instructions
- Implement ONLY task 18: "Create event subscriber in pages/content/src/communication/event-subscriber.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks content-scripts 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks content-scripts 18 --mode complete
```
