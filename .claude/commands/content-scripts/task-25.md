# content-scripts - Task 25

Execute task 25 for the content-scripts specification.

## Task Description
Create browser detector in pages/content/src/compatibility/browser-detector.ts

## Code Reuse
**Leverage existing code**: chrome-extension browser detection utilities
...
## Usage
```
/Task:25-content-scripts
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create browser detector in pages/content/src/compatibility/browser-detector.ts"

```
Use the @spec-task-executor agent to implement task 25: "Create browser detector in pages/content/src/compatibility/browser-detector.ts" for the content-scripts specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create browser detector in pages/content/src/compatibility/browser-detector.ts
- Leverage: chrome-extension browser detection utilities
- Requirements: 5.1, 5.2, 5.3

## Instructions
- Implement ONLY task 25: "Create browser detector in pages/content/src/compatibility/browser-detector.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks content-scripts 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks content-scripts 25 --mode complete
```
