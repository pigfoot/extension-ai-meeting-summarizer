# content-scripts - Task 21

Execute task 21 for the content-scripts specification.

## Task Description
Create content analyzer in pages/content/src/analysis/content-analyzer.ts

## Code Reuse
**Leverage existing code**: packages/meeting-detector content analysis
...
## Usage
```
/Task:21-content-scripts
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create content analyzer in pages/content/src/analysis/content-analyzer.ts"

```
Use the @spec-task-executor agent to implement task 21: "Create content analyzer in pages/content/src/analysis/content-analyzer.ts" for the content-scripts specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create content analyzer in pages/content/src/analysis/content-analyzer.ts
- Leverage: packages/meeting-detector content analysis
- Requirements: 4.1

## Instructions
- Implement ONLY task 21: "Create content analyzer in pages/content/src/analysis/content-analyzer.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks content-scripts 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks content-scripts 21 --mode complete
```
