# content-scripts - Task 20

Execute task 20 for the content-scripts specification.

## Task Description
Create background coordinator in pages/content/src/communication/background-coordinator.ts

## Code Reuse
**Leverage existing code**: pages/content/src/communication/message-dispatcher.ts, pages/content/src/communication/state-synchronizer.ts
...
## Usage
```
/Task:20-content-scripts
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create background coordinator in pages/content/src/communication/background-coordinator.ts"

```
Use the @spec-task-executor agent to implement task 20: "Create background coordinator in pages/content/src/communication/background-coordinator.ts" for the content-scripts specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create background coordinator in pages/content/src/communication/background-coordinator.ts
- Leverage: pages/content/src/communication/message-dispatcher.ts, pages/content/src/communication/state-synchronizer.ts
- Requirements: 3.1, 3.2, 3.3, 3.4

## Instructions
- Implement ONLY task 20: "Create background coordinator in pages/content/src/communication/background-coordinator.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks content-scripts 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks content-scripts 20 --mode complete
```
