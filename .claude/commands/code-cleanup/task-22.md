...
Execute task 22 for the code-cleanup specification.

## Task Description
Run comprehensive ESLint validation across all packages
...
## Usage
```
/Task:22-code-cleanup
```

## Instructions

Execute with @spec-task-executor agent the following task: "Run comprehensive ESLint validation across all packages"

```
Use the @spec-task-executor agent to implement task 22: "Run comprehensive ESLint validation across all packages" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Run comprehensive ESLint validation across all packages
- Requirements: R1.4, R5.1

## Instructions
- Implement ONLY task 22: "Run comprehensive ESLint validation across all packages"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 22 --mode complete
```
