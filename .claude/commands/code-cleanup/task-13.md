...
Execute task 13 for the code-cleanup specification.

## Task Description
Clean up unused variables in chrome-extension/src/background/
...
Execute with @spec-task-executor agent the following task: "Clean up unused variables in chrome-extension/src/background/"

```
Use the @spec-task-executor agent to implement task 13: "Clean up unused variables in chrome-extension/src/background/" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Clean up unused variables in chrome-extension/src/background/
- Requirements: R1.2, R1.3

## Instructions
- Implement ONLY task 13: "Clean up unused variables in chrome-extension/src/background/"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 13 --mode complete
```
