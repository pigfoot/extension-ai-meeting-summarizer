...
Execute task 4 for the code-cleanup specification.

## Task Description
Backup current ESLint configuration in eslint.config.backup.ts
...
Execute with @spec-task-executor agent the following task: "Backup current ESLint configuration in eslint.config.backup.ts"

```
Use the @spec-task-executor agent to implement task 4: "Backup current ESLint configuration in eslint.config.backup.ts" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Backup current ESLint configuration in eslint.config.backup.ts
- Requirements: R1.1

## Instructions
- Implement ONLY task 4: "Backup current ESLint configuration in eslint.config.backup.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 4 --mode complete
```
