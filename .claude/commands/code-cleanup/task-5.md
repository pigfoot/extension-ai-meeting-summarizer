...
Execute task 5 for the code-cleanup specification.

## Task Description
Remove unused imports from packages/shared
...
Execute with @spec-task-executor agent the following task: "Remove unused imports from packages/shared"

```
Use the @spec-task-executor agent to implement task 5: "Remove unused imports from packages/shared" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Remove unused imports from packages/shared
- Leverage: scripts/cleanup/validate-cleanup.ts
- Requirements: R2.2

## Instructions
- Implement ONLY task 5: "Remove unused imports from packages/shared"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 5 --mode complete
```
