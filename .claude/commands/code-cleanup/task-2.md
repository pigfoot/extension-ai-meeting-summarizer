...
Execute task 2 for the code-cleanup specification.

## Task Description
Create cleanup validation script in scripts/cleanup/validate-cleanup.ts

## Requirements Reference
**Requirements**: R1.4, R5.1
...
Execute with @spec-task-executor agent the following task: "Create cleanup validation script in scripts/cleanup/validate-cleanup.ts"

```
Use the @spec-task-executor agent to implement task 2: "Create cleanup validation script in scripts/cleanup/validate-cleanup.ts" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create cleanup validation script in scripts/cleanup/validate-cleanup.ts
- Requirements: R1.4, R5.1

## Instructions
- Implement ONLY task 2: "Create cleanup validation script in scripts/cleanup/validate-cleanup.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 2 --mode complete
```
