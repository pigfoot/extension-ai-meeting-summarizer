...
Execute task 8 for the code-cleanup specification.

## Task Description
Remove unused imports from packages/meeting-detector

## Code Reuse
**Leverage existing code**: scripts/cleanup/validate-cleanup.ts
...
Execute with @spec-task-executor agent the following task: "Remove unused imports from packages/meeting-detector"

```
Use the @spec-task-executor agent to implement task 8: "Remove unused imports from packages/meeting-detector" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Remove unused imports from packages/meeting-detector
- Leverage: scripts/cleanup/validate-cleanup.ts
- Requirements: R2.2

## Instructions
- Implement ONLY task 8: "Remove unused imports from packages/meeting-detector"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 8 --mode complete
```
