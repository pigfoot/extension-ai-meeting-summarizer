...
Execute task 9 for the code-cleanup specification.

## Task Description
Clean up unused variables in packages/shared
...
Execute with @spec-task-executor agent the following task: "Clean up unused variables in packages/shared"

```
Use the @spec-task-executor agent to implement task 9: "Clean up unused variables in packages/shared" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 9
- Description: Clean up unused variables in packages/shared
- Requirements: R1.2, R1.3

## Instructions
- Implement ONLY task 9: "Clean up unused variables in packages/shared"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 9 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 9 --mode complete
```
