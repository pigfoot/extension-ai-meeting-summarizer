...
Execute task 6 for the code-cleanup specification.

## Task Description
Remove unused imports from packages/storage
...
Execute with @spec-task-executor agent the following task: "Remove unused imports from packages/storage"

```
Use the @spec-task-executor agent to implement task 6: "Remove unused imports from packages/storage" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Remove unused imports from packages/storage
- Leverage: scripts/cleanup/validate-cleanup.ts
- Requirements: R2.2

## Instructions
- Implement ONLY task 6: "Remove unused imports from packages/storage"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 6 --mode complete
```
