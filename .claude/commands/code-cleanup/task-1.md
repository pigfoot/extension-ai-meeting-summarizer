...
Execute task 1 for the code-cleanup specification.

## Task Description
Generate unused code analysis report across all packages

## Requirements Reference
**Requirements**: R1.1, R2.2
...
Execute with @spec-task-executor agent the following task: "Generate unused code analysis report across all packages"

```
Use the @spec-task-executor agent to implement task 1: "Generate unused code analysis report across all packages" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: Generate unused code analysis report across all packages
- Requirements: R1.1, R2.2

## Instructions
- Implement ONLY task 1: "Generate unused code analysis report across all packages"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 1 --mode complete
```
