...
Execute task 7 for the code-cleanup specification.

## Task Description
Remove unused imports from packages/azure-speech
...
Execute with @spec-task-executor agent the following task: "Remove unused imports from packages/azure-speech"

```
Use the @spec-task-executor agent to implement task 7: "Remove unused imports from packages/azure-speech" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Remove unused imports from packages/azure-speech
- Leverage: scripts/cleanup/validate-cleanup.ts
- Requirements: R2.2

## Instructions
- Implement ONLY task 7: "Remove unused imports from packages/azure-speech"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 7 --mode complete
```
