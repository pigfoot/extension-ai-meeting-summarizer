# code-cleanup - Task 11

Execute task 11 for the code-cleanup specification.

## Task Description
Clean up unused variables in packages/azure-speech
...
Execute with @spec-task-executor agent the following task: "Clean up unused variables in packages/azure-speech"

```
Use the @spec-task-executor agent to implement task 11: "Clean up unused variables in packages/azure-speech" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Clean up unused variables in packages/azure-speech
- Requirements: R1.2, R1.3

## Instructions
- Implement ONLY task 11: "Clean up unused variables in packages/azure-speech"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 11 --mode complete
```
