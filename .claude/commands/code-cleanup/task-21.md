# code-cleanup - Task 21

Execute task 21 for the code-cleanup specification.

## Task Description
Restore strict ESLint unused variable rules in eslint.config.ts
...
Execute with @spec-task-executor agent the following task: "Restore strict ESLint unused variable rules in eslint.config.ts"

```
Use the @spec-task-executor agent to implement task 21: "Restore strict ESLint unused variable rules in eslint.config.ts" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Restore strict ESLint unused variable rules in eslint.config.ts
- Requirements: R1.1

## Instructions
- Implement ONLY task 21: "Restore strict ESLint unused variable rules in eslint.config.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 21 --mode complete
```
