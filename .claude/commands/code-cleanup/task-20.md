# code-cleanup - Task 20

Execute task 20 for the code-cleanup specification.

## Task Description
Eliminate remaining any types across all packages
...
Execute with @spec-task-executor agent the following task: "Eliminate remaining any types across all packages"

```
Use the @spec-task-executor agent to implement task 20: "Eliminate remaining any types across all packages" for the code-cleanup specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Eliminate remaining any types across all packages
- Requirements: R2.1

## Instructions
- Implement ONLY task 20: "Eliminate remaining any types across all packages"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks code-cleanup 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks code-cleanup 20 --mode complete
```
