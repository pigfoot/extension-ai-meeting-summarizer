...
Execute task 4 for the testing-qa specification.

## Task Description
Create Chrome Extension mocks in tests/mocks/chrome-extension-mocks.ts

## Code Reuse
**Leverage existing code**: chrome-extension API usage patterns
...
Execute with @spec-task-executor agent the following task: "Create Chrome Extension mocks in tests/mocks/chrome-extension-mocks.ts"

```
Use the @spec-task-executor agent to implement task 4: "Create Chrome Extension mocks in tests/mocks/chrome-extension-mocks.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Create Chrome Extension mocks in tests/mocks/chrome-extension-mocks.ts
- Leverage: chrome-extension API usage patterns
- Requirements: 1.1, 2.3

## Instructions
- Implement ONLY task 4: "Create Chrome Extension mocks in tests/mocks/chrome-extension-mocks.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 4 --mode complete
```
