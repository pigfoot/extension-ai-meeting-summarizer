...
Execute task 18 for the testing-qa specification.

## Task Description
Create test page fixtures in tests/e2e/fixtures/test-pages.ts

## Code Reuse
**Leverage existing code**: SharePoint/Teams page structures
...
Execute with @spec-task-executor agent the following task: "Create test page fixtures in tests/e2e/fixtures/test-pages.ts"

```
Use the @spec-task-executor agent to implement task 18: "Create test page fixtures in tests/e2e/fixtures/test-pages.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create test page fixtures in tests/e2e/fixtures/test-pages.ts
- Leverage: SharePoint/Teams page structures
- Requirements: 3.3

## Instructions
- Implement ONLY task 18: "Create test page fixtures in tests/e2e/fixtures/test-pages.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 18 --mode complete
```
