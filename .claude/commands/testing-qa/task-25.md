...
Execute task 25 for the testing-qa specification.

## Task Description
Create transcription accuracy tests in tests/qa/accuracy/transcription-accuracy.test.ts

## Code Reuse
**Leverage existing code**: packages/azure-speech and test audio samples
...
Execute with @spec-task-executor agent the following task: "Create transcription accuracy tests in tests/qa/accuracy/transcription-accuracy.test.ts"

```
Use the @spec-task-executor agent to implement task 25: "Create transcription accuracy tests in tests/qa/accuracy/transcription-accuracy.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create transcription accuracy tests in tests/qa/accuracy/transcription-accuracy.test.ts
- Leverage: packages/azure-speech and test audio samples
- Requirements: 5.1

## Instructions
- Implement ONLY task 25: "Create transcription accuracy tests in tests/qa/accuracy/transcription-accuracy.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 25 --mode complete
```
