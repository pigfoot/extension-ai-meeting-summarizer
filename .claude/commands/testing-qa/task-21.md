...
Execute task 21 for the testing-qa specification.

## Task Description
Create performance test utilities in tests/performance/utils/performance-utils.ts

## Code Reuse
**Leverage existing code**: browser performance APIs
...
Execute with @spec-task-executor agent the following task: "Create performance test utilities in tests/performance/utils/performance-utils.ts"

```
Use the @spec-task-executor agent to implement task 21: "Create performance test utilities in tests/performance/utils/performance-utils.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create performance test utilities in tests/performance/utils/performance-utils.ts
- Leverage: browser performance APIs
- Requirements: 4.3

## Instructions
- Implement ONLY task 21: "Create performance test utilities in tests/performance/utils/performance-utils.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 21 --mode complete
```
