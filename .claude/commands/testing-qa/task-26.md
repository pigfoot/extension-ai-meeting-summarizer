...
Execute task 26 for the testing-qa specification.

## Task Description
Create accessibility tests in tests/qa/accessibility/accessibility.test.ts

## Code Reuse
**Leverage existing code**: packages/ui components and accessibility utilities
...
Execute with @spec-task-executor agent the following task: "Create accessibility tests in tests/qa/accessibility/accessibility.test.ts"

```
Use the @spec-task-executor agent to implement task 26: "Create accessibility tests in tests/qa/accessibility/accessibility.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Create accessibility tests in tests/qa/accessibility/accessibility.test.ts
- Leverage: packages/ui components and accessibility utilities
- Requirements: 5.3

## Instructions
- Implement ONLY task 26: "Create accessibility tests in tests/qa/accessibility/accessibility.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 26 --mode complete
```
