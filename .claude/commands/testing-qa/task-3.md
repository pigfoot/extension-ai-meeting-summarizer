...
Execute task 3 for the testing-qa specification.

## Task Description
Create mock factories in tests/mocks/mock-factories.ts

## Code Reuse
**Leverage existing code**: packages/shared/lib/types for data structures
...
Execute with @spec-task-executor agent the following task: "Create mock factories in tests/mocks/mock-factories.ts"

```
Use the @spec-task-executor agent to implement task 3: "Create mock factories in tests/mocks/mock-factories.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create mock factories in tests/mocks/mock-factories.ts
- Leverage: packages/shared/lib/types for data structures
- Requirements: 1.2, 1.3

## Instructions
- Implement ONLY task 3: "Create mock factories in tests/mocks/mock-factories.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 3 --mode complete
```
