...
Execute task 15 for the testing-qa specification.

## Task Description
Create background service integration tests in tests/integration/background-integration.test.ts

## Code Reuse
**Leverage existing code**: chrome-extension/src/background implementation
...
Execute with @spec-task-executor agent the following task: "Create background service integration tests in tests/integration/background-integration.test.ts"

```
Use the @spec-task-executor agent to implement task 15: "Create background service integration tests in tests/integration/background-integration.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create background service integration tests in tests/integration/background-integration.test.ts
- Leverage: chrome-extension/src/background implementation
- Requirements: 2.3

## Instructions
- Implement ONLY task 15: "Create background service integration tests in tests/integration/background-integration.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 15 --mode complete
```
