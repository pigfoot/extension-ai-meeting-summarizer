...
Execute task 2 for the testing-qa specification.

## Task Description
Create test utilities in tests/utils/test-utils.tsx

## Code Reuse
**Leverage existing code**: existing test utility patterns
...
Execute with @spec-task-executor agent the following task: "Create test utilities in tests/utils/test-utils.tsx"

```
Use the @spec-task-executor agent to implement task 2: "Create test utilities in tests/utils/test-utils.tsx" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create test utilities in tests/utils/test-utils.tsx
- Leverage: existing test utility patterns
- Requirements: 1.1

## Instructions
- Implement ONLY task 2: "Create test utilities in tests/utils/test-utils.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 2 --mode complete
```
