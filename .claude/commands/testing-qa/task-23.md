...
Execute task 23 for the testing-qa specification.

## Task Description
Create concurrent job performance tests in tests/performance/concurrent-jobs.test.ts

## Code Reuse
**Leverage existing code**: tests/performance/utils/performance-utils.ts
...
Execute with @spec-task-executor agent the following task: "Create concurrent job performance tests in tests/performance/concurrent-jobs.test.ts"

```
Use the @spec-task-executor agent to implement task 23: "Create concurrent job performance tests in tests/performance/concurrent-jobs.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create concurrent job performance tests in tests/performance/concurrent-jobs.test.ts
- Leverage: tests/performance/utils/performance-utils.ts
- Requirements: 4.2

## Instructions
- Implement ONLY task 23: "Create concurrent job performance tests in tests/performance/concurrent-jobs.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 23 --mode complete
```
