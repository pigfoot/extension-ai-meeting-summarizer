...
Execute task 24 for the testing-qa specification.

## Task Description
Create large file performance tests in tests/performance/large-files.test.ts
...
Execute with @spec-task-executor agent the following task: "Create large file performance tests in tests/performance/large-files.test.ts"

```
Use the @spec-task-executor agent to implement task 24: "Create large file performance tests in tests/performance/large-files.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Create large file performance tests in tests/performance/large-files.test.ts
- Leverage: tests/performance/utils/performance-utils.ts
- Requirements: 4.4

## Instructions
- Implement ONLY task 24: "Create large file performance tests in tests/performance/large-files.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 24 --mode complete
```
