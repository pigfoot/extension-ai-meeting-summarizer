...
Execute task 20 for the testing-qa specification.

## Task Description
Create cross-browser E2E tests in tests/e2e/cross-browser/browser-compatibility.test.ts

## Code Reuse
**Leverage existing code**: tests/e2e/workflows/transcription-workflow.test.ts
...
Execute with @spec-task-executor agent the following task: "Create cross-browser E2E tests in tests/e2e/cross-browser/browser-compatibility.test.ts"

```
Use the @spec-task-executor agent to implement task 20: "Create cross-browser E2E tests in tests/e2e/cross-browser/browser-compatibility.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create cross-browser E2E tests in tests/e2e/cross-browser/browser-compatibility.test.ts
- Leverage: tests/e2e/workflows/transcription-workflow.test.ts
- Requirements: 3.2

## Instructions
- Implement ONLY task 20: "Create cross-browser E2E tests in tests/e2e/cross-browser/browser-compatibility.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 20 --mode complete
```
