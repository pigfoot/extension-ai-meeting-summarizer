...
Execute task 6 for the testing-qa specification.

## Task Description
Create Azure Speech unit tests in tests/unit/packages/azure-speech/azure-speech.test.ts

## Code Reuse
**Leverage existing code**: packages/azure-speech implementation
...
Execute with @spec-task-executor agent the following task: "Create Azure Speech unit tests in tests/unit/packages/azure-speech/azure-speech.test.ts"

```
Use the @spec-task-executor agent to implement task 6: "Create Azure Speech unit tests in tests/unit/packages/azure-speech/azure-speech.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create Azure Speech unit tests in tests/unit/packages/azure-speech/azure-speech.test.ts
- Leverage: packages/azure-speech implementation
- Requirements: 1.3, 2.2

## Instructions
- Implement ONLY task 6: "Create Azure Speech unit tests in tests/unit/packages/azure-speech/azure-speech.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 6 --mode complete
```
