...
Execute task 22 for the testing-qa specification.

## Task Description
Create startup performance tests in tests/performance/startup-performance.test.ts
...
Execute with @spec-task-executor agent the following task: "Create startup performance tests in tests/performance/startup-performance.test.ts"

```
Use the @spec-task-executor agent to implement task 22: "Create startup performance tests in tests/performance/startup-performance.test.ts" for the testing-qa specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create startup performance tests in tests/performance/startup-performance.test.ts
- Leverage: tests/performance/utils/performance-utils.ts
- Requirements: 4.1

## Instructions
- Implement ONLY task 22: "Create startup performance tests in tests/performance/startup-performance.test.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks testing-qa 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks testing-qa 22 --mode complete
```
