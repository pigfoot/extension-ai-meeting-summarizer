# ui-architecture - Task 14

Execute task 14 for the ui-architecture specification.

## Task Description
Create status indicator in packages/ui/lib/components/StatusIndicator.tsx

## Code Reuse
**Leverage existing code**: packages/ui/lib/components icon and badge patterns
...
## Usage
```
/Task:14-ui-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create status indicator in packages/ui/lib/components/StatusIndicator.tsx"

```
Use the @spec-task-executor agent to implement task 14: "Create status indicator in packages/ui/lib/components/StatusIndicator.tsx" for the ui-architecture specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create status indicator in packages/ui/lib/components/StatusIndicator.tsx
- Leverage: packages/ui/lib/components icon and badge patterns
- Requirements: 3.1

## Instructions
- Implement ONLY task 14: "Create status indicator in packages/ui/lib/components/StatusIndicator.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui-architecture 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui-architecture 14 --mode complete
```
