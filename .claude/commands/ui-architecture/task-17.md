# ui-architecture - Task 17

Execute task 17 for the ui-architecture specification.

## Task Description
Create summary card component in packages/ui/lib/components/SummaryCard.tsx

## Code Reuse
**Leverage existing code**: packages/ui/lib/components card and accordion patterns
...
## Usage
```
/Task:17-ui-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create summary card component in packages/ui/lib/components/SummaryCard.tsx"

```
Use the @spec-task-executor agent to implement task 17: "Create summary card component in packages/ui/lib/components/SummaryCard.tsx" for the ui-architecture specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create summary card component in packages/ui/lib/components/SummaryCard.tsx
- Leverage: packages/ui/lib/components card and accordion patterns
- Requirements: 4.1

## Instructions
- Implement ONLY task 17: "Create summary card component in packages/ui/lib/components/SummaryCard.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui-architecture 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui-architecture 17 --mode complete
```
