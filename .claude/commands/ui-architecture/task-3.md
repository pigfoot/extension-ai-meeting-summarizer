...
Execute task 3 for the ui-architecture specification.

## Task Description
Create progress monitoring types in packages/ui/lib/types/progress.ts

## Code Reuse
**Leverage existing code**: packages/ui/lib/types structure
...
Execute with @spec-task-executor agent the following task: "Create progress monitoring types in packages/ui/lib/types/progress.ts"

```
Use the @spec-task-executor agent to implement task 3: "Create progress monitoring types in packages/ui/lib/types/progress.ts" for the ui-architecture specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create progress monitoring types in packages/ui/lib/types/progress.ts
- Leverage: packages/ui/lib/types structure
- Requirements: 3.1, 3.2

## Instructions
- Implement ONLY task 3: "Create progress monitoring types in packages/ui/lib/types/progress.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui-architecture 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui-architecture 3 --mode complete
```
