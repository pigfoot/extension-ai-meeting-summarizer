# ui-architecture - Task 7

Execute task 7 for the ui-architecture specification.

## Task Description
Create summary preview in pages/popup/src/components/SummaryPreview.tsx

## Code Reuse
**Leverage existing code**: packages/ui/lib/components preview patterns
...
Execute with @spec-task-executor agent the following task: "Create summary preview in pages/popup/src/components/SummaryPreview.tsx"

```
Use the @spec-task-executor agent to implement task 7: "Create summary preview in pages/popup/src/components/SummaryPreview.tsx" for the ui-architecture specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create summary preview in pages/popup/src/components/SummaryPreview.tsx
- Leverage: packages/ui/lib/components preview patterns
- Requirements: 1.3

## Instructions
- Implement ONLY task 7: "Create summary preview in pages/popup/src/components/SummaryPreview.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui-architecture 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui-architecture 7 --mode complete
```
