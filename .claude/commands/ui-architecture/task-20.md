# ui-architecture - Task 20

Execute task 20 for the ui-architecture specification.

## Task Description
Create export manager in packages/ui/lib/components/ExportManager.tsx

## Code Reuse
**Leverage existing code**: packages/ui/lib/components dropdown and download patterns
...
## Usage
```
/Task:20-ui-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create export manager in packages/ui/lib/components/ExportManager.tsx"

```
Use the @spec-task-executor agent to implement task 20: "Create export manager in packages/ui/lib/components/ExportManager.tsx" for the ui-architecture specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create export manager in packages/ui/lib/components/ExportManager.tsx
- Leverage: packages/ui/lib/components dropdown and download patterns
- Requirements: 4.4

## Instructions
- Implement ONLY task 20: "Create export manager in packages/ui/lib/components/ExportManager.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks ui-architecture 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks ui-architecture 20 --mode complete
```
